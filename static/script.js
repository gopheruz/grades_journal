...
async function fetchStudents() {
  try {
    const res = await fetch("http://146.190.67.159:8080/students/");
...
async function fetchSubjects() {
  try {
    const res = await fetch("http://146.190.67.159:8080/subjects/");
...
async function fetchGrades() {
  try {
    const res = await fetch("http://146.190.67.159:8080/grades/");
...
async function addStudent() {
  ...
  if (!name) return;
  try {
    await fetch("http://146.190.67.159:8080/students/", {
      method: "POST",
...
async function addSubject() {
  ...
  if (!name) return;
  try {
    await fetch("http://146.190.67.159:8080/subjects/", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ name })
    });
...
async function updateGrade(studentId, subjectId, score) {
  try {
    await fetch("http://146.190.67.159:8080/grades/", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
